...
namespace Blog.Core.AOP.Middleware
{
    public static class SwaggerMiddleware
    {
        public static void UseSwaggerUI(this IApplicationBuilder app)
        {
            app.UseSwaggerUI(options =>
            {
                ...
                Func<Stream> indexStream = () => Assembly.Load("Blog").GetManifestResourceStream("Blog.index.html");
                ...
                //API页面标题
                options.DocumentTitle = "Blog_ApiDoc";
