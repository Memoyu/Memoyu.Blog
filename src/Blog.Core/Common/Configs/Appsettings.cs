...
namespace Blog.Core.Common.Configs
{
    ...
    public class Appsettings
    {
        ...
        public class GitHub
        {
            ...
            public static string ClientId => _configuration["Github:ClientID"];

            public static string ClientSecret => _configuration["Github:ClientSecret"];

            public static string RedirectUri => _configuration["Github:RedirectUri"];

            public static string AppName => _configuration["Github:ApplicationName"];
