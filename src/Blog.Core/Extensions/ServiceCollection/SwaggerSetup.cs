using Blog.Core.AOP.Filters;
using Blog.Core.Domains.Common.Options;
...
namespace Blog.Core.Extensions.ServiceCollection
{
    /// <summary>
    /// 配置注册Swagger
    /// </summary>
    public static class SwaggerSetup
    {
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(opt =>
            {
                ...
                opt.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Blog.xml"));
                opt.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Blog.Service.xml"));
