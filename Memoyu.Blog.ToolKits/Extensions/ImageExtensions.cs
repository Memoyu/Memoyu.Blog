...
namespace Memoyu.Blog.ToolKits.Extensions
{
    public static class ImageExtensions
    {
        ...
        {
            watermarkImgPath = StringExtensions.IsNullOrEmpty(watermarkImgPath) ? Path.Combine(Directory.GetCurrentDirectory(), "Resources/watermark.png") : watermarkImgPath;
